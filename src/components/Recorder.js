...
class Recorder extends Component {
  ...
  async startRecording(e) {
    e.preventDefault();
    // wipe old data chunks and disable text change
    this.chunks = [];
  ...
  render() {
    const { recording, stopped, audios, time, medianotFound, pauseRecord } = this.state;
                      ...
                      <button
                        onClick={
                          () => {
                            ...
                            this.setState({ time: {}, miliseconds: 0, stopped: false });
                          }
                        }
